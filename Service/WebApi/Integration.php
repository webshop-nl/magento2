...
namespace WebshopNL\Connect\Service\WebApi;
...
class Integration
{
    ...
    public const INTEGRATION_NAME = 'WebshopNL Integration';
    ...
    public function createToken(bool $update = false): string
    {
        ...
        $customerId = $integration->getConsumerId();
        $this->authorizationService->grantPermissions($integrationId, ['WebshopNL_Connect::webapi']);
