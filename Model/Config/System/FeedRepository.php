...
use WebshopNL\Connect\Api\Config\System\FeedInterface;
...
class FeedRepository extends BaseRepository implements FeedInterface
{
    ...
    public function getAllEnabledStoreIds(): array
    {
        ...
        foreach ($this->storeManager->getStores() as $store) {
            if ($this->isFeedEnabled((int)$store->getId()) && $store->getIsActive()) {
    ...
    {
        return $this->isSetFlag(self::XPATH_FEED_ENABLED, $storeId);
    }
     ...
     *
     * @return string
     * @see \WebshopNL\Connect\Model\Config\System\Source\SourceType
     */
